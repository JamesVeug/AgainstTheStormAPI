...
internal static class Configs
{
    ...
    private static ConfigEntry<bool> m_ExportEnumTypes = Bind("Exporting", "Export Enum classes", false, 
        "When set to true and the Export Enums path is set, the plugin will export all types of data as .cs files for the API to use or anyone to browse.");
    
    private static ConfigEntry<string> m_ExportEnumsPath = Bind("Exporting", "Export Enum class path", "", 
        "When set to true this is the path the enums will export to");

    private static ConfigEntry<bool> m_ExportCSVs = Bind("Exporting", "Export CSVs", false, 
        "When set to true and the Export CSVs path is set, the plugin will export all types of data as .csv files for anyone to browse.");
    
    private static ConfigEntry<string> m_ExportCSVsPath = Bind("Exporting", "Export CSVs path", "", 
        "When set to true");
