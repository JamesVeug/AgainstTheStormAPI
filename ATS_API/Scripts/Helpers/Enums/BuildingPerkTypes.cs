...
public enum BuildingPerkTypes
{
	...
	/// Reliability - Increases the chance for extra production yields by {0}.
	/// </summary>
	/// <name>[R][Altar] Extra Production Chance - Cathode</name>
	RAltar_Extra_Production_Chance_Cathode = 74,

	/// <summary>
	/// Efficiency - Increases production speed by {0}.
	/// </summary>
	/// <name>[R][Altar] Production Rate Core - Cathode</name>
	RAltar_Production_Rate_Core_Cathode = 75,
	...
	/// <summary>
	/// Book of Water - Increases the chance for extra production yields by {0}.
	/// </summary>
	/// <name>Water Extractor Extra Production Chance - building perk</name>
	Water_Extractor_Extra_Production_Chance_Building_Perk = 76,
...
public static class BuildingPerkTypesExtensions
{
	...
	internal static readonly Dictionary<BuildingPerkTypes, string> TypeToInternalName = new()
	{
		...
		{ BuildingPerkTypes.RAltar_Extra_Production_Chance_Cathode, "[R][Altar] Extra Production Chance - Cathode" },                           // Reliability - Increases the chance for extra production yields by {0}.
		{ BuildingPerkTypes.RAltar_Production_Rate_Core_Cathode, "[R][Altar] Production Rate Core - Cathode" },                                 // Efficiency - Increases production speed by {0}.
		...
		{ BuildingPerkTypes.Water_Extractor_Extra_Production_Chance_Building_Perk, "Water Extractor Extra Production Chance - building perk" }, // Book of Water - Increases the chance for extra production yields by {0}.
