...
public enum VillagerPerkTypes
{
	...
	Charmed_Long_Break,                       // Kelpie's Charm - The villager is under the river kelpie's spell, and cannot work until the event is completed.
	cMdlt_Distracted_PiercingWinds,           // Distracted - Villagers with this effect have a +20% chance of destroying the yield with each production cycle.
	...
	cMdlt_Distracted_UnnervingSilence,        // Distracted - Villagers with this effect have a +20% chance of destroying the yield with each production cycle.
	...
	cMdlt_LowResolve_HomelessInStorm,         // Soaked Clothes - Villagers with this effect have soaked clothes and get a -5 penalty to their Resolve. (‑5 to Global Resolve)
	...
	cMdlt_Slowed_Downpour,                    // Exhausted - Villagers with this effect move –40% slower.
	...
	Faster_Woocutters,                        // Specialized Boots - Woodcutters move +20% faster.
	...
	Rainpunk_Comfortable,                     // Low Strain - Work is much easier with Rain Engines on (+5 to Resolve). (+5 to Global Resolve)
	...
	Shorter_Break,                            // Drying Boards - Time spent resting is reduced by 30% when under the effect of <sprite name="[needs] coats"> clothing.
	...
	Very_Long_Breaks,                         // Drying Boards - Time spent resting is reduced by 10000% when under the effect of <sprite name="[needs] coats"> clothing.
...
public static class VillagerPerkTypesExtensions
{
	...
	public static VillagerPerkTypes[] All()
	{
		if (s_All == null)
		{
			s_All = new VillagerPerkTypes[70];
			for (int i = 0; i < 70; i++)
			{
	...
	internal static readonly Dictionary<VillagerPerkTypes, string> TypeToInternalName = new()
	{
		...
		{ VillagerPerkTypes.Charmed_Long_Break, "Charmed (Long Break)" },                                             // Kelpie's Charm - The villager is under the river kelpie's spell, and cannot work until the event is completed.
		{ VillagerPerkTypes.cMdlt_Distracted_PiercingWinds, "cMdlt_Distracted_PiercingWinds" },                       // Distracted - Villagers with this effect have a +20% chance of destroying the yield with each production cycle.
		...
		{ VillagerPerkTypes.cMdlt_Distracted_UnnervingSilence, "cMdlt_Distracted_UnnervingSilence" },                 // Distracted - Villagers with this effect have a +20% chance of destroying the yield with each production cycle.
		...
		{ VillagerPerkTypes.cMdlt_LowResolve_HomelessInStorm, "cMdlt_LowResolve_HomelessInStorm" },                   // Soaked Clothes - Villagers with this effect have soaked clothes and get a -5 penalty to their Resolve. (‑5 to Global Resolve)
		...
		{ VillagerPerkTypes.cMdlt_Slowed_Downpour, "cMdlt_Slowed_Downpour" },                                         // Exhausted - Villagers with this effect move –40% slower.
		...
		{ VillagerPerkTypes.Faster_Woocutters, "Faster Woocutters" },                                                 // Specialized Boots - Woodcutters move +20% faster.
		...
		{ VillagerPerkTypes.Rainpunk_Comfortable, "Rainpunk Comfortable" },                                           // Low Strain - Work is much easier with Rain Engines on (+5 to Resolve). (+5 to Global Resolve)
		...
		{ VillagerPerkTypes.Shorter_Break, "Shorter Break" },                                                         // Drying Boards - Time spent resting is reduced by 30% when under the effect of <sprite name="[needs] coats"> clothing.
		...
		{ VillagerPerkTypes.Very_Long_Breaks, "Very Long Breaks" },                                                   // Drying Boards - Time spent resting is reduced by 10000% when under the effect of <sprite name="[needs] coats"> clothing.
