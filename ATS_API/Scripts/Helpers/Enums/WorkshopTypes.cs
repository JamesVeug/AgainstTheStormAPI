...
{
	/// <summary>
	/// Returns how many enum values are in WorkshopTypes.
	/// </summary>
	...
	public static WorkshopTypes ToWorkshopTypes(this string name)
	{
		...
		APILogger.LogWarning("Cannot find WorkshopTypes with name: " + name + "\n" + Environment.StackTrace);
	...
	{
		{ WorkshopTypes.Alchemist_Hut, "Alchemist Hut" },                                 // Alchemist's Hut - Can produce:  [metal] crystalized dew Crystalized Dew (grade2), [needs] tea Tea (grade2), [needs] wine Wine (grade2).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Apothecary, "Apothecary" },                                       // Apothecary - Can produce:  [needs] tea Tea (grade2), [crafting] dye Dye (grade2), [food processed] jerky Jerky (grade2).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Artisan, "Artisan" },                                             // Artisan - Can produce:  [vessel] barrels Barrels (grade2), [needs] coats Coats (grade2), [needs] scrolls Scrolls (grade2).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Bakery, "Bakery" },                                               // Bakery - Can produce:  [food processed] biscuits Biscuits (grade2), [food processed] pie Pie (grade2), [vessel] pottery Pottery (grade2).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Beanery, "Beanery" },                                             // Beanery - Can produce:  [food processed] porridge Porridge (grade3), [food processed] pickled goods Pickled Goods (grade1), [metal] crystalized dew Crystalized Dew (grade1).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Brewery, "Brewery" },                                             // Brewery - Can produce:  [needs] ale Ale (grade3), [food processed] porridge Porridge (grade2), [packs] pack of crops Pack of Crops (grade1).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Brick_Oven, "Brick Oven" },                                       // Brick Oven - Can produce:  [food processed] biscuits Biscuits (grade3), [needs] incense Incense (grade2), [crafting] coal Coal (grade1).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Brickyard, "Brickyard" },                                         // Brickyard - Can produce:  [mat processed] bricks Bricks (grade3), [vessel] pottery Pottery (grade2), [metal] crystalized dew Crystalized Dew (grade1).  Rain engine: "[water] storm water" Storm Water.
		{ WorkshopTypes.Butcher, "Butcher" },                                             // Butcher - Can produce:  [food processed] skewers Skewers (grade2), [food processed] jerky Jerky (grade2), [crafting] oil Oil (grade2).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Cannery, "Cannery" },                                             // Cannery - Can produce:  [food processed] paste Paste (grade3), [needs] wine Wine (grade2), [food processed] biscuits Biscuits (grade1).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Carpenter, "Carpenter" },                                         // Carpenter - Can produce:  [mat processed] planks Planks (grade2), [tools] simple tools Tools (grade2), [packs] pack of luxury goods Pack of Luxury Goods (grade2).  Rain engine: "[water] storm water" Storm Water.
		{ WorkshopTypes.Cellar, "Cellar" },                                               // Cellar - Can produce:  [needs] wine Wine (grade3), [food processed] pickled goods Pickled Goods (grade2), [packs] pack of provisions Pack of Provisions (grade1).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Clay_Pit_Workshop, "Clay Pit Workshop" },                         // Clay Pit - Uses Clearance Water to produce goods regardless of the season. Must be placed on fertile soil. Can produce:  [mat raw] clay Clay (grade2), [mat raw] reeds Reed (grade2), [mat raw] resin Resin (grade2) Rain engine: "[water] storm water" Storm Water.
		{ WorkshopTypes.Clothier, "Clothier" },                                           // Clothier - Can produce:  [needs] coats Coats (grade3), [packs] pack of building materials Pack of Building Materials (grade2), [vessel] waterskin Waterskins (grade1).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Cobbler, "Cobbler" },                                             // Cobbler - Can produce:  [needs] boots Boots (grade3), [packs] pack of building materials Pack of Building Materials (grade2), [crafting] dye Dye (grade1).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Cookhouse, "Cookhouse" },                                         // Cookhouse - Can produce:  [food processed] skewers Skewers (grade2), [food processed] biscuits Biscuits (grade2), [food processed] porridge Porridge (grade2).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Cooperage, "Cooperage" },                                         // Cooperage - Can produce:  [vessel] barrels Barrels (grade3), [needs] coats Coats (grade2), [packs] pack of luxury goods Pack of Luxury Goods (grade1).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Crude_Workstation, "Crude Workstation" },                         // Crude Workstation - Can produce:  [mat processed] planks Planks (grade0), [mat processed] fabric Fabric (grade0), [mat processed] bricks Bricks (grade0), [mat processed] pipe Pipes (grade0).  Rain engine: "[water] storm water" Storm Water.
		{ WorkshopTypes.Distillery, "Distillery" },                                       // Distillery - Can produce:  [needs] ale Ale (grade2), [needs] incense Incense (grade2), [food processed] pickled goods Pickled Goods (grade2).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Druid, "Druid" },                                                 // Druid's Hut - Can produce:  [crafting] oil Oil (grade3), [needs] tea Tea (grade2), [needs] coats Coats (grade1).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Field_Kitchen, "Field Kitchen" },                                 // Field Kitchen - Can produce:  [food processed] skewers Skewers (grade0), [food processed] paste Paste (grade0), [food processed] biscuits Biscuits (grade0), [food processed] pickled goods Pickled Goods (grade0).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Finesmith, "Finesmith" },                                         // Finesmith - Can produce:  [valuable] amber Amber (grade3), [tools] simple tools Tools (grade3).  Rain engine: "[water] storm water" Storm Water.
		{ WorkshopTypes.Flawless_Brewery, "Flawless Brewery" },                           // Flawless Brewery - An upgraded production building with all recipes at the highest grade. Can produce:  [needs] ale Ale (grade3), [food processed] porridge Porridge (grade3), [packs] pack of crops Pack of Crops (grade3). Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Flawless_Cellar, "Flawless Cellar" },                             // Flawless Cellar - An upgraded production building with all recipes at the highest grade. Can produce:  [needs] wine Wine (grade3), [food processed] pickled goods Pickled Goods (grade3), [packs] pack of provisions Pack of Provisions (grade3). Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Flawless_Cooperage, "Flawless Cooperage" },                       // Flawless Cooperage - An upgraded production building with all recipes at the highest grade. Can produce:  [vessel] barrels Barrels (grade3), [needs] coats Coats (grade3), [packs] pack of luxury goods Pack of Luxury Goods (grade3). Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Flawless_Druid, "Flawless Druid" },                               // Flawless Druid's Hut - An upgraded production building with all recipes at the highest grade. Can produce:  [crafting] oil Oil (grade3), [needs] tea Tea (grade3), [needs] coats Coats (grade3). Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Flawless_Leatherworks, "Flawless Leatherworks" },                 // Flawless Leatherworker - An upgraded production building with all recipes at the highest grade. Can produce:  [vessel] waterskin Waterskins (grade3), [needs] boots Boots (grade3), [needs] training gear Training Gear (grade3). Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Flawless_Rain_Mill, "Flawless Rain Mill" },                       // Flawless Rain Mill - An upgraded production building with all recipes at the highest grade. Can produce:  [crafting] flour Flour (grade3), [needs] scrolls Scrolls (grade3), [food processed] paste Paste (grade3). Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Flawless_Smelter, "Flawless Smelter" },                           // Flawless Smelter - An upgraded production building with all recipes at the highest grade. Can produce:  [metal] copper bar Copper Bars (grade3), [needs] training gear Training Gear (grade3), [food processed] pie Pie (grade3). Rain engine: "[water] storm water" Storm Water.
		{ WorkshopTypes.Furnace, "Furnace" },                                             // Furnace - Can produce:  [food processed] pie Pie (grade2), [food processed] skewers Skewers (grade2), [metal] copper bar Copper Bars (grade2).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Granary, "Granary" },                                             // Granary - Can produce:  [food processed] pickled goods Pickled Goods (grade2), [mat processed] fabric Fabric (grade2), [packs] pack of crops Pack of Crops (grade2).  Rain engine: "[water] drizzle water" Drizzle Water.
		...
		{ WorkshopTypes.Grill, "Grill" },                                                 // Grill - Can produce:  [food processed] skewers Skewers (grade3), [food processed] paste Paste (grade2), [metal] copper bar Copper Bars (grade1).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Kiln, "Kiln" },                                                   // Kiln - Can produce:  [crafting] coal Coal (grade3), [mat processed] bricks Bricks (grade1), [food processed] jerky Jerky (grade1).  Rain engine: "[water] storm water" Storm Water.
		{ WorkshopTypes.Leatherworks, "Leatherworks" },                                   // Leatherworker - Can produce:  [vessel] waterskin Waterskins (grade3), [needs] boots Boots (grade2), [needs] training gear Training Gear (grade1).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Lumbermill, "Lumbermill" },                                       // Lumber Mill - Can produce:  [mat processed] planks Planks (grade3), [needs] scrolls Scrolls (grade1), [packs] pack of trade goods Pack of Trade Goods (grade1).  Rain engine: "[water] storm water" Storm Water.
		{ WorkshopTypes.Makeshift_Post, "Makeshift Post" },                               // Makeshift Post - Can produce:  [packs] pack of crops Pack of Crops (grade0), [packs] pack of provisions Pack of Provisions (grade0), [packs] pack of building materials Pack of Building Materials (grade0).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Manufactory, "Manufactory" },                                     // Manufactory - Can produce:  [mat processed] fabric Fabric (grade2), [vessel] barrels Barrels (grade2), [crafting] dye Dye (grade2).  Rain engine: "[water] storm water" Storm Water.
		{ WorkshopTypes.Pantry, "Pantry" },                                               // Pantry - Can produce:  [food processed] porridge Porridge (grade2), [food processed] pie Pie (grade2), [packs] pack of luxury goods Pack of Luxury Goods (grade2).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Press, "Press" },                                                 // Press - Can produce:  [crafting] oil Oil (grade3), [crafting] flour Flour (grade1), [food processed] paste Paste (grade1).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Provisioner, "Provisioner" },                                     // Provisioner - Can produce:  [crafting] flour Flour (grade2), [vessel] barrels Barrels (grade2), [packs] pack of provisions Pack of Provisions (grade2).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Rain_Mill, "Rain Mill" },                                         // Rain Mill - Can produce:  [crafting] flour Flour (grade3), [needs] scrolls Scrolls (grade1), [food processed] paste Paste (grade1).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Rainpunk_Foundry, "Rainpunk Foundry" },                           // Rainpunk Foundry - A very advanced piece of technology. Can produce  [mat processed] parts Parts (grade3), hearth parts Wildfire Essence (grade3). Rain engine: "[water] storm water" Storm Water.
		{ WorkshopTypes.Ranch, "Ranch" },                                                 // Ranch - Can produce:  [food raw] meat Meat (grade1), [mat raw] leather Leather (grade1), [food raw] eggs Eggs (grade1).  Rain engine: "[water] drizzle water" Drizzle Water.
		{ WorkshopTypes.Scribe, "Scribe" },                                               // Scribe - Can produce:  [needs] scrolls Scrolls (grade3), [packs] pack of trade goods Pack of Trade Goods (grade2), [needs] ale Ale (grade1).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Smelter, "Smelter" },                                             // Smelter - Can produce:  [metal] copper bar Copper Bars (grade3), [needs] training gear Training Gear (grade2), [food processed] pie Pie (grade1).  Rain engine: "[water] storm water" Storm Water.
		{ WorkshopTypes.Smithy, "Smithy" },                                               // Smithy - Can produce:  [tools] simple tools Tools (grade2), [mat processed] pipe Pipes (grade2), [packs] pack of trade goods Pack of Trade Goods (grade2).  Rain engine: "[water] storm water" Storm Water.
		{ WorkshopTypes.Smokehouse, "Smokehouse" },                                       // Smokehouse - Can produce:  [food processed] jerky Jerky (grade3), [vessel] pottery Pottery (grade1), [needs] incense Incense (grade1).  Rain engine: "[water] drizzle water" Drizzle Water.
		...
		{ WorkshopTypes.Weaver, "Weaver" },                                               // Weaver - Can produce:  [mat processed] fabric Fabric (grade3), [needs] boots Boots (grade1), [needs] training gear Training Gear (grade1).  Rain engine: "[water] clearance water" Clearance Water.
		{ WorkshopTypes.Workshop, "Workshop" },                                           // Workshop - Can produce:  [mat processed] planks Planks (grade2), [mat processed] fabric Fabric (grade2), [mat processed] bricks Bricks (grade2), [mat processed] pipe Pipes (grade0).  Rain engine: "[water] storm water" Storm Water.
