...
public enum MetaRewardTypes
{
	...
	Meta_Perk_Unlock_Corruption_Per_Removed_Cyst_Minus50,      // Firekeeper's Armor
	...
	Meta_Reward_Home_Decor_Ancient_Artifact,                   // Ancient Artifact
	Meta_Reward_Home_Decor_Domesticated_Sea_Tiger,             // Domesticated Sea Tiger
	Meta_Reward_Home_Decor_Dueling_Umbrella,                   // Dueling Umbrella
	Meta_Reward_Home_Decor_Fishman_Skull,                      // Fishman Skull
	Meta_Reward_Home_Decor_Ibex_Rug,                           // Ibex Rug
	Meta_Reward_Home_Decor_Inscribed_Slab,                     // Inscribed Slab
	Meta_Reward_Home_Decor_Landscape_Painting,                 // Landscape Painting
	Meta_Reward_Home_Decor_Marshglow_Fungite,                  // Marshglow Fungite
	Meta_Reward_Home_Decor_Mole_Trophy,                        // Mole Trophy
	Meta_Reward_Home_Decor_Painting_Of_The_Ancient_Hearth,     // Painting of the Ancient Hearth
	Meta_Reward_Home_Decor_Plate_Of_Food,                      // Plate of Food
	Meta_Reward_Home_Decor_Reefbloom,                          // Reefbloom
	Meta_Reward_Home_Decor_Rosevine,                           // Rosevine
	Meta_Reward_Home_Decor_Sparkdew_Crystal,                   // Sparkdew Crystal
	Meta_Reward_Home_Decor_Storm_Orb,                          // Storm Orb
	Meta_Reward_Home_Decor_The_Sparkcaster,                    // The Sparkcaster
	Meta_Reward_Home_Decor_Trade_Contract,                     // Trade Contract
	Meta_Reward_Home_Decor_Uniform_0_Standard_Uniform,         // Standard Uniform
	Meta_Reward_Home_Decor_Uniform_1_Settlers_Mask,            // Settler's Mask
	Meta_Reward_Home_Decor_Uniform_2_Pioneers_Mantle,          // Pioneer's Mantle
	Meta_Reward_Home_Decor_Uniform_3_Veterans_Shoulder_Guard,  // Veteran's Shoulder Guard
	Meta_Reward_Home_Decor_Uniform_4_Viceroys_Cape,            // Viceroy's Cape
	Meta_Reward_Home_Decor_Uniform_5_Decorated_Belt,           // Decorated Belt
	Meta_Reward_Home_Decor_Uniform_6_Royal_Visage,             // Royal Visage
	Meta_Reward_Home_Decor_Uniform_7_Stormshroud_Attire,       // Stormshroud Attire
	Meta_Reward_Home_Decor_Uniform_8_Crimson_Cloak,            // Crimson Cloak
	Meta_Reward_Home_Decor_Uniform_9_Queens_Hand_Pauldron,     // Queen's Hand Pauldron
...
public static class MetaRewardTypesExtensions
{
	...
	internal static readonly Dictionary<MetaRewardTypes, string> TypeToInternalName = new()
	{
		...
		{ MetaRewardTypes.Meta_Perk_Unlock_Corruption_Per_Removed_Cyst_Minus50, "Meta Perk Unlock Corruption Per Removed Cyst -50" },                  // Firekeeper's Armor
		...
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Ancient_Artifact, "Meta Reward Home Decor - Ancient Artifact" },                                      // Ancient Artifact
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Domesticated_Sea_Tiger, "Meta Reward Home Decor - Domesticated Sea Tiger" },                          // Domesticated Sea Tiger
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Dueling_Umbrella, "Meta Reward Home Decor - Dueling Umbrella" },                                      // Dueling Umbrella
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Fishman_Skull, "Meta Reward Home Decor - Fishman Skull" },                                            // Fishman Skull
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Ibex_Rug, "Meta Reward Home Decor - Ibex Rug" },                                                      // Ibex Rug
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Inscribed_Slab, "Meta Reward Home Decor - Inscribed Slab" },                                          // Inscribed Slab
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Landscape_Painting, "Meta Reward Home Decor - Landscape Painting" },                                  // Landscape Painting
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Marshglow_Fungite, "Meta Reward Home Decor - Marshglow Fungite" },                                    // Marshglow Fungite
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Mole_Trophy, "Meta Reward Home Decor - Mole Trophy" },                                                // Mole Trophy
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Painting_Of_The_Ancient_Hearth, "Meta Reward Home Decor - Painting of the Ancient Hearth" },          // Painting of the Ancient Hearth
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Plate_Of_Food, "Meta Reward Home Decor - Plate of Food" },                                            // Plate of Food
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Reefbloom, "Meta Reward Home Decor - Reefbloom" },                                                    // Reefbloom
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Rosevine, "Meta Reward Home Decor - Rosevine" },                                                      // Rosevine
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Sparkdew_Crystal, "Meta Reward Home Decor - Sparkdew Crystal" },                                      // Sparkdew Crystal
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Storm_Orb, "Meta Reward Home Decor - Storm Orb" },                                                    // Storm Orb
		{ MetaRewardTypes.Meta_Reward_Home_Decor_The_Sparkcaster, "Meta Reward Home Decor - The Sparkcaster" },                                        // The Sparkcaster
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Trade_Contract, "Meta Reward Home Decor - Trade Contract" },                                          // Trade Contract
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Uniform_0_Standard_Uniform, "Meta Reward Home Decor - Uniform 0 - Standard Uniform" },                // Standard Uniform
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Uniform_1_Settlers_Mask, "Meta Reward Home Decor - Uniform 1 - Settler's Mask" },                     // Settler's Mask
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Uniform_2_Pioneers_Mantle, "Meta Reward Home Decor - Uniform 2 - Pioneer's Mantle" },                 // Pioneer's Mantle
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Uniform_3_Veterans_Shoulder_Guard, "Meta Reward Home Decor - Uniform 3 - Veteran's Shoulder Guard" }, // Veteran's Shoulder Guard
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Uniform_4_Viceroys_Cape, "Meta Reward Home Decor - Uniform 4 - Viceroy's Cape" },                     // Viceroy's Cape
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Uniform_5_Decorated_Belt, "Meta Reward Home Decor - Uniform 5 - Decorated Belt" },                    // Decorated Belt
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Uniform_6_Royal_Visage, "Meta Reward Home Decor - Uniform 6 - Royal Visage" },                        // Royal Visage
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Uniform_7_Stormshroud_Attire, "Meta Reward Home Decor - Uniform 7 - Stormshroud Attire" },            // Stormshroud Attire
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Uniform_8_Crimson_Cloak, "Meta Reward Home Decor - Uniform 8 - Crimson Cloak" },                      // Crimson Cloak
		{ MetaRewardTypes.Meta_Reward_Home_Decor_Uniform_9_Queens_Hand_Pauldron, "Meta Reward Home Decor - Uniform 9 - Queen's Hand Pauldron" },       // Queen's Hand Pauldron
