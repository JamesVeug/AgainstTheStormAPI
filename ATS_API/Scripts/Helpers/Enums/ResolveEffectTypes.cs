...
public enum ResolveEffectTypes
{
	...
	API_ExampleMod_API_ExampleMod_AxolotlHouse_housingNeed_resolveEffect,            // API_ExampleMod_API_ExampleMod_AxolotlHouse_housingNeed_displayName - API_ExampleMod_API_ExampleMod_AxolotlHouse_housingNeed_description
	API_ExampleMod_API_ExampleMod_Borgor_complexFoodNeed_equalPenaltyResolveEffect,  // Rationing - No one likes being denied the fruits of their own labor.
	API_ExampleMod_API_ExampleMod_Borgor_complexFoodNeed_resolveEffect, 
	API_ExampleMod_API_ExampleMod_Borgor_complexFoodNeed_unfairPenaltyResolveEffect, // Unfair Rationing - Villagers get very upset if they are denied things their neighbors can still consume.
...
public static class ResolveEffectTypesExtensions
{
	...
	public static ResolveEffectTypes[] All()
	{
		if (s_All == null)
		{
			s_All = new ResolveEffectTypes[168];
			for (int i = 0; i < 168; i++)
			{
	...
	internal static readonly Dictionary<ResolveEffectTypes, string> TypeToInternalName = new()
	{
		...
		{ ResolveEffectTypes.API_ExampleMod_API_ExampleMod_AxolotlHouse_housingNeed_resolveEffect, "API_ExampleMod_API_ExampleMod_AxolotlHouse_housingNeed_resolveEffect" },                       // API_ExampleMod_API_ExampleMod_AxolotlHouse_housingNeed_displayName - API_ExampleMod_API_ExampleMod_AxolotlHouse_housingNeed_description
